...
public class ClientDeliveryFrame extends JFrame {
...
private static final long serialVersionUID = 1L;
	 ...
	 */
	public ClientDeliveryFrame () {
		
		// Default frame setting
		getContentPane().setLayout(new BorderLayout());
		this.setTitle("TCP Application: Delivery Bay Side");
		this.setSize(new Dimension(778, 788));  
		...
		// Row, Column
		this.txtRequestStatus  = new JTextArea(40, 70);
